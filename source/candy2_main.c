/*------------------------------------------------------------------------------
	...
	Programador 1: josep.ribas@estudiants.urv.cat
	Programador 2: ivan.morillas@estudiants.urv.cat
	Programador 3: miguel.lopes@estudiants.urv.cat
...
int main(void)
{
	...
	printf("\x1b[38m\x1b[4;0H JOC DE PROVES GELATINES");
	printf("\x1b[38m\x1b[5;0H 6 PROVES");
	...
	do							// bucle principal del juego
	{
		...
		if (change)				//////	SECCIÓN CAMBIO DE NIVEL	//////
		{
			switch(level){
			case 0: 
			printf("\x1b[38m\x1b[6;0H Nivell: Gelatina doble");
			break; 
			case 1: 
			printf("\x1b[38m\x1b[6;0H Nivell: Valla         ");
			break; 
			case 2: 
			printf("\x1b[38m\x1b[6;0H Nivell: Huecos         ");
			break; 
			case 3: 
			printf("\x1b[38m\x1b[6;0H Nivell: Gelatina simple         ");
			break;
			case 4: 
			printf("\x1b[38m\x1b[6;0H Nivell: MIX                         ");
			break; 
			case 5: 
			printf("\x1b[38m\x1b[6;0H Nivell: 0 gelatines 		         ");
			break;
